...
<div class="" style="width:100%;min-height:100vh;">
  <section class="section-container clearfix" style="position:relative;">
    <div id="accordion" class="accordion" style="width:20%;position:fixed;top:100px;z-index:1">
           ...
           <hr />
            <nav aria-label="Page navigation example">
              <ul class="pagination d-flex justify-content-between">
                <li class="page-item" style="visibility:'.$displayButtonNavPrevious.';"><a class="page-link" href="/course?id='.$_GET['id'].'&moduleid='.$previousTopicID['moduleID'].'&topicid='.$previousTopicID['previuosTopicID'].'" style="background:#34b3a0;color:#ffffff">'.$previousTopicID['topicTitle'].'</a></li>
                <li class="page-item" style="visibility:'.$displayButtonNavNext.';"><a class="page-link" href="/course?id='.$_GET['id'].'&moduleid='.$nextTopicID['moduleID'].'&topicid='.$nextTopicID['nextTopicID'].'" style="background:#34b3a0;color:#ffffff">'.$nextTopicID['topicTitle'].'</a></li>
              </ul>
           </nav>
        </div>';
         ?>
